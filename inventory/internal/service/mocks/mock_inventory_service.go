...
import (
	...
	model "github.com/mercuryqa/rocket-lab/inventory/internal/model"
...
// GetPart provides a mock function with given fields: ctx, string2
func (_m *InventoryService) GetPart(ctx context.Context, string2 string) (model.Part, error) {
	ret := _m.Called(ctx, string2)
...
//   - ctx context.Context
//   - string2 string
func (_e *InventoryService_Expecter) GetPart(ctx interface{}, string2 interface{}) *InventoryService_GetPart_Call {
	return &InventoryService_GetPart_Call{Call: _e.mock.On("GetPart", ctx, string2)}
}

func (_c *InventoryService_GetPart_Call) Run(run func(ctx context.Context, string2 string)) *InventoryService_GetPart_Call {
...
func (_m *InventoryService) ListParts(ctx context.Context, filter model.PartsFilter) (*model.ListPartsResponse, error) {
...
func (_c *InventoryService_ListParts_Call) RunAndReturn(run func(context.Context, model.PartsFilter) (*model.ListPartsResponse, error)) *InventoryService_ListParts_Call {
	_c.Call.Return(run)
	return _c
}
