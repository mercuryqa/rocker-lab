...
func (_m *PaymentService) PayOrder(ctx context.Context, info model.PayOrderRequest) (model.PayOrderResponse, error) {
...
func (_e *PaymentService_Expecter) PayOrder(ctx interface{}, info interface{}) *PaymentService_PayOrder_Call {
	return &PaymentService_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx, info)}
}

func (_c *PaymentService_PayOrder_Call) Run(run func(ctx context.Context, info model.PayOrderRequest)) *PaymentService_PayOrder_Call {
